...
docker run -it --mount src=$(pwd),target=/home/waterFern,type=bind --name waterfern-frontend -p5000:5000 waterfern/frontend /bin/sh -c 'export LC_ALL=C.UTF-8 && export LANG=C.UTF-8 && cd /home/waterFern/website && cd .. && python3 main.py & bash'